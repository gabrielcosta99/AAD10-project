...
static void md5_cpu_avx2(v16si *interleaved8_data,v16si *interleaved8_hash)
{ // eight interleaved messages -> eight interleaved MD5 hashes
  v16si a,b,c,d,interleaved8_state[4],interleaved8_x[16];
# define C(c)         (v16si){ (int)(c),(int)(c),(int)(c),(int)(c),(int)(c),(int)(c),(int)(c),(int)(c) }
# define ROTATE(x,n)  (__builtin_ia32_pslldi512(x,n) | __builtin_ia32_psrldi512(x,32 - (n)))
...
# define N_TIMING_TESTS  1000000u
  ...
  for(n = 0u;n < N_MESSAGES;n += 16u)
  {
    ...
    //
    for (lane = 0u; lane < 16u; lane++)  // for 16 lanes
        for (idx = 0u; idx < 4u; idx++)    // for 4 hash words
